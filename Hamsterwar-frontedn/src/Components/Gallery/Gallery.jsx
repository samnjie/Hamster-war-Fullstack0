...
const Gallery = (props) => {
  ...
  useEffect(() => {
    const getHamsters = async () => {
      ...
      const response = await fetch("https://hamsters-backend-90f4de1edeea.herokuapp.com/hamsters");
  ...
  const removeHamster = async (id) => {
    ...
    await fetch(`https://hamsters-backend-90f4de1edeea.herokuapp.com/hamsters/${id}`, request);
    setListUpdated(true);
  };
